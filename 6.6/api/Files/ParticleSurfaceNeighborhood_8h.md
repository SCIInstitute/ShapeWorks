...
class ParticleSurfaceNeighborhood : public ParticleRegionNeighborhood {
 public:
  ...
  bool is_weighting_enabled() const { return m_WeightingEnabled; }

  void set_force_euclidean(bool is_enabled) { m_ForceEuclidean = is_enabled; }

  bool is_force_euclidean() const { return m_ForceEuclidean; }
