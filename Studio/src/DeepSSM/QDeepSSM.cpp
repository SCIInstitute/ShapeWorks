...
void QDeepSSM::initialize_python()
{
  ...
  if (!python_initialized) {
    ...
    /*
    sys.attr("path").attr("insert")(0, "/Users/amorris/sci/shapeworks/code/Python/DatasetUtilsPackage");
    sys.attr("path").attr("insert")(0, "/Users/amorris/anaconda3/envs/shapeworks/lib/python3.7/site-packages");
    sys.attr("path").attr("insert")(0, "/Users/amorris/.local/lib/python3.7/site-packages");
    sys.attr("path").attr("insert")(0, "/Users/amorris/anaconda3/envs/shapeworks/lib/python3.7/lib-dynload");
    sys.attr("path").attr("insert")(0, "/Users/amorris/anaconda3/envs/shapeworks/lib/python3.7");
    sys.attr("path").attr("insert")(0, "/Users/amorris/anaconda3/envs/shapeworks/lib/python37.zip");
    sys.attr("path").attr("insert")(0, "/Users/amorris/sci/shapeworks/code/Python/DataAugmentationUtilsPackage");
*/
    std::vector<std::string> python_path;
    python_path.push_back("/Users/amorris/sci/shapeworks/code/Python/DataAugmentationUtilsPackage");
    python_path.push_back("/Users/amorris/anaconda3/envs/shapeworks/lib/python37.zip");
    python_path.push_back("/Users/amorris/anaconda3/envs/shapeworks/lib/python3.7");
    python_path.push_back("/Users/amorris/anaconda3/envs/shapeworks/lib/python3.7/lib-dynload");
    python_path.push_back("/Users/amorris/.local/lib/python3.7/site-packages");
    python_path.push_back("/Users/amorris/anaconda3/envs/shapeworks/lib/python3.7/site-packages");
    python_path.push_back("/Users/amorris/sci/shapeworks/code/Python/DatasetUtilsPackage");
