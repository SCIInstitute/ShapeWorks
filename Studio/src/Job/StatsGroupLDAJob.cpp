...
//---------------------------------------------------------------------------
StatsGroupLDAJob::StatsGroupLDAJob(ParticleShapeStatistics stats) : stats_(stats)
{}
...
//---------------------------------------------------------------------------
QString StatsGroupLDAJob::name()
{
  return "Group p-values";
}
//---------------------------------------------------------------------------

Eigen::VectorXf StatsGroupLDAJob::get_group_pvalues()
{
