...
// TypeError: 'shapeworks.Point3' object is not subscriptable
  ...
  .def("binaryBoundingBox",     &shapeworks::Image::binaryBoundingBox, "filenames"_a)
  .def("crop",                  &shapeworks::Image::crop, "region"_a)
  .def("clip",                  &shapeworks::Image::clip, "o"_a, "p1"_a, "p2"_a, "val"_a=0.0)
  .def("clip",                  &shapeworks::Image::clip, "n"_a, "q"_a, "val"_a=0.0)
  ...
  .def("pad",                   &shapeworks::Image::Region::pad, "other"_a=shapeworks::Image::Region)
  .def("shrink",                &shapeworks::Image::Region::shrink, "other"_a=shapeworks::Image::Region)
  .def("grow",                  &shapeworks::Image::Region::grow, "other"_a=shapeworks::Image::Region)
  .def("expand",                &shapeworks::Image::Region::expand, "other"_a=shapeworks::Image::Region)
  ;
