...
if __name__=="__main__":
    dataset_names = ["ellipsoid_tiny_test"]
    project_files = ["/home/sci/mkaranam/Desktop/ShapeWorks/Examples/Python/Output/ellipsoid/ellipsoid_tiny_test_multiscale.swproj"]
    descriptions = ["Uploading ellipsoid tiny test dataset"]
