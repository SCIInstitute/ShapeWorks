...

{
 ...
 public:
...

  {
    ...
    m_Sampler->GetEnsembleEntropyFunction()->SetMinimumVarianceDecay(initial_min_variance_spinner->value(), final_min_variance_spinner->value(),min_variance_decay_iterations->value());

    m_Sampler->GetGeneralEntropyGradientFunction()->SetMinimumVarianceDecay(initial_min_variance_spinner->value(), final_min_variance_spinner->value(),min_variance_decay_iterations->value());

    m_Sampler->GetEnsembleRegressionEntropyFunction()->SetMinimumVarianceDecay(initial_min_variance_spinner->value(), final_min_variance_spinner->value(), min_variance_decay_iterations->value());
