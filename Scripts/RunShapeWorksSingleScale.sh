...
echo $model_suffix
paramSWDir=${out_dir}paramfiles_${model_suffix}/
modelDir=${out_dir}model_${model_suffix}/
modelLogDir=${out_dir}model_${model_suffix}_logs/
...
echo "1.0" >> $xmlfilename
echo "1.0" >> $xmlfilename
echo "1.0" >> $xmlfilename #$wtNormals
echo "1.0" >> $xmlfilename #$wtNormals
echo "1.0" >> $xmlfilename #$wtNormals
echo "</attribute_scales>" >> $xmlfilename
fi
