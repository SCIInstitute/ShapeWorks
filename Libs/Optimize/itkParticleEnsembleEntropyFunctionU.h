...
/**
 * \class ParticleEnsembleEntropyFunctionU
 *
 */
template <unsigned int VDimension>
class ParticleEnsembleEntropyFunctionU : public ParticleVectorFunction<VDimension>
{
public:
 /** Standard class typedefs. */
  typedef ParticleEnsembleEntropyFunctionU Self;
  typedef SmartPointer<Self>  Pointer;
  typedef SmartPointer<const Self>  ConstPointer;
  typedef ParticleVectorFunction<VDimension> Superclass;
  itkTypeMacro( ParticleEnsembleEntropyFunctionU, ParticleVectorFunction);
  ...
  double GetMaximumUpdateAllowd() 
  { return m_MinimumEigenValue; }

  void SetMaximumUpdateAllowed(double val)
  { m_MinimumEigenValue = val; }
  ...
  {
    typename ParticleEnsembleEntropyFunctionU<VDimension>::Pointer copy = ParticleEnsembleEntropyFunctionU<VDimension>::New();
...
protected:
  ParticleEnsembleEntropyFunctionU()
  {
  ...
  virtual ~ParticleEnsembleEntropyFunctionU() {}
  void operator=(const ParticleEnsembleEntropyFunctionU &);
  ParticleEnsembleEntropyFunctionU(const ParticleEnsembleEntropyFunctionU &);
