           ...
           double &maxmove, double &energy) const
{
    ...
    typename ParticleSystemType::PointVectorType m_CurrentNeighborhood = system->FindNeighborhoodPoints(pos, m_GlobalSigma[d], KK_LOCATION, d);
    ...
    {
        PointType pos_k = m_CurrentNeighborhood[k].Point;
        typename ParticleSystemType::PointVectorType k_neighborhood = system->FindNeighborhoodPoints(pos_k, m_GlobalSigma[d], KK_LOCATION, d);
