...
void Sampler::Execute()
{
  ...
  // Sets up for adaptive splitting
  this->GetOptimizer()->setAdaptiveSplitting(m_adaptive_splitting);
  this->GetOptimizer()->SetPredictedParticleSpacing(m_predicted_particle_spacing);
