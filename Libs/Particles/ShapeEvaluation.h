...
class ShapeEvaluation {
 public:
  ...
  static double compute_compactness(const ParticleSystemEvaluation& particle_system,
                                    const int num_modes,
  ...
  static double compute_generalization(const ParticleSystemEvaluation& particle_system,
                                       const int num_modes,
                                       const std::string& save_to = "");
  ...
  static double compute_specificity(const ParticleSystemEvaluation& particle_system,
                                    const int nModes,
                                    const std::string& save_to = "");
