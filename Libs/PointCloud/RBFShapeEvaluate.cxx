...
int main(int argc, char *argv[])
{
    ...
    {
        std::cerr << "-------------------------------" << std::endl;
        std::cerr << "RBFShapeEvaluate " << std::endl;
        std::cerr << "-------------------------------" << std::endl;

        std::cerr << "Given an set of points and a built RBFShape file, it evaluates the distance between the points and the shape representation. \n" << std::endl;
        ...
        std::cerr << "\t - output: A file with the distances to every point from the input." << std::endl;
    ...
    if(debug){
        std::cout << "-------------------------------" << std::endl;
        std::cout << "RBFShapeEvaluate " << std::endl;
        std::cout << "-------------------------------" << std::endl;
    ...
    std::vector<double> evaluations = shape.batch_evaluate(ev_pts);
