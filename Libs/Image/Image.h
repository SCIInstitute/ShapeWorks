...
public:
  ...
  Image &binarize(PixelType minval = std::numeric_limits<PixelType>::epsilon(), PixelType maxval = std::numeric_limits<PixelType>::max(), PixelType inner_value = 1.0, PixelType outer_value = 0.0);
