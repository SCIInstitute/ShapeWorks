...
public:
  ...
  TransformPtr createTransform(TransformMethod type = CenterOfMass);

  /// creates a transform based on transform type
  TransformPtr createTransform(const Image &target, TransformMethod type = IterativeClosestPoint, float isoValue = 0.0, unsigned iterations = 20);
