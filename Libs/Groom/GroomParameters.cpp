...
//---------------------------------------------------------------------------
void GroomParameters::restore_defaults() { this->params_.reset_parameters(); }

//---------------------------------------------------------------------------
bool GroomParameters::get_isolate_tool() { return this->params_.get(Keys::ISOLATE, Defaults::isolate); }

//---------------------------------------------------------------------------
void GroomParameters::set_isolate_tool(bool value) { this->params_.set(Keys::ISOLATE, value); }

//---------------------------------------------------------------------------
bool GroomParameters::get_fill_holes_tool() { return this->params_.get(Keys::FILL_HOLES, Defaults::fill_holes); }

//---------------------------------------------------------------------------
void GroomParameters::set_fill_holes_tool(bool value) { this->params_.set(Keys::FILL_HOLES, value); }
...
//---------------------------------------------------------------------------
void GroomParameters::set_fill_mesh_holes_tool(bool value) { this->params_.set(Keys::FILL_MESH_HOLES, value); }

//---------------------------------------------------------------------------
bool GroomParameters::get_auto_pad_tool() { return this->params_.get(Keys::PAD, Defaults::pad); }

//---------------------------------------------------------------------------
void GroomParameters::set_auto_pad_tool(bool value) { this->params_.set(Keys::PAD, value); }

//---------------------------------------------------------------------------
int GroomParameters::get_padding_amount() { return this->params_.get(Keys::PAD_VALUE, Defaults::pad_value); }

//---------------------------------------------------------------------------
void GroomParameters::set_padding_amount(int padding_amount) { this->params_.set(Keys::PAD_VALUE, padding_amount); }

//---------------------------------------------------------------------------
bool GroomParameters::get_antialias_tool() { return this->params_.get(Keys::ANTIALIAS, Defaults::antialias); }

//---------------------------------------------------------------------------
void GroomParameters::set_antialias_tool(bool value) { this->params_.set(Keys::ANTIALIAS, value); }
...
//---------------------------------------------------------------------------
bool GroomParameters::get_blur_tool() { return this->params_.get(Keys::BLUR, Defaults::blur); }

//---------------------------------------------------------------------------
void GroomParameters::set_blur_tool(bool value) { this->params_.set(Keys::BLUR, value); }

//---------------------------------------------------------------------------
double GroomParameters::get_blur_amount() { return this->params_.get(Keys::BLUR_SIGMA, Defaults::blur_sigma); }

//---------------------------------------------------------------------------
void GroomParameters::set_blur_amount(double blur_amount) { this->params_.set(Keys::BLUR_SIGMA, blur_amount); }

//---------------------------------------------------------------------------
bool GroomParameters::get_fast_marching() { return this->params_.get(Keys::FASTMARCHING, Defaults::fastmarching); }

//---------------------------------------------------------------------------
void GroomParameters::set_fast_marching(bool value) { this->params_.set(Keys::FASTMARCHING, value); }
...
//---------------------------------------------------------------------------
bool GroomParameters::get_mesh_smooth() { return this->params_.get(Keys::MESH_SMOOTH, Defaults::mesh_smooth); }

//---------------------------------------------------------------------------
void GroomParameters::set_mesh_smooth(bool value) { this->params_.set(Keys::MESH_SMOOTH, value); }
...
std::string GroomParameters::get_alignment_method() {
  if (!this->params_.key_exists(Keys::ALIGNMENT_METHOD)) {
    ...
    if (this->params_.key_exists(Keys::ICP) && this->params_.get(Keys::ICP, false)) {
      return GROOM_ALIGNMENT_ICP_C;
    }
    if (this->params_.key_exists(Keys::CENTER)) {
      if (this->params_.get(Keys::CENTER, false)) {
...
//---------------------------------------------------------------------------
void GroomParameters::set_alignment_method(std::string method) { this->params_.set(Keys::ALIGNMENT_METHOD, method); }
...
//---------------------------------------------------------------------------
void GroomParameters::set_alignment_enabled(bool value) { this->params_.set(Keys::ALIGNMENT_ENABLED, value); }
...
//---------------------------------------------------------------------------
bool GroomParameters::get_crop() { return this->params_.get(Keys::CROP, Defaults::crop); }

//---------------------------------------------------------------------------
void GroomParameters::set_crop(bool crop) { this->params_.set(Keys::CROP, crop); }

//---------------------------------------------------------------------------
bool GroomParameters::get_convert_to_mesh() { return this->params_.get(Keys::CONVERT_MESH, Defaults::convert_mesh); }

//---------------------------------------------------------------------------
void GroomParameters::set_convert_to_mesh(bool value) { this->params_.set(Keys::CONVERT_MESH, value); }

//---------------------------------------------------------------------------
bool GroomParameters::get_reflect() { return this->params_.get(Keys::REFLECT, Defaults::reflect); }

//---------------------------------------------------------------------------
void GroomParameters::set_reflect(bool reflect) { this->params_.set(Keys::REFLECT, reflect); }

//---------------------------------------------------------------------------
std::string GroomParameters::get_reflect_column() { return this->params_.get(Keys::REFLECT_COLUMN, ""); }

//---------------------------------------------------------------------------
void GroomParameters::set_reflect_column(std::string column) { this->params_.set(Keys::REFLECT_COLUMN, column); }

//---------------------------------------------------------------------------
std::string GroomParameters::get_reflect_choice() { return this->params_.get(Keys::REFLECT_CHOICE, ""); }

//---------------------------------------------------------------------------
void GroomParameters::set_reflect_choice(std::string choice) { this->params_.set(Keys::REFLECT_CHOICE, choice); }
...
//---------------------------------------------------------------------------
void GroomParameters::set_reflect_axis(std::string axis) { return this->params_.set(Keys::REFLECT_AXIS, axis); }

//---------------------------------------------------------------------------
bool GroomParameters::get_resample() { return this->params_.get(Keys::RESAMPLE, Defaults::resample); }

//---------------------------------------------------------------------------
void GroomParameters::set_resample(bool resample) { this->params_.set(Keys::RESAMPLE, resample); }

//---------------------------------------------------------------------------
bool GroomParameters::get_isotropic() { return this->params_.get(Keys::ISOTROPIC, Defaults::isotropic); }

//---------------------------------------------------------------------------
void GroomParameters::set_isotropic(bool isotropic) { this->params_.set(Keys::ISOTROPIC, isotropic); }

//---------------------------------------------------------------------------
double GroomParameters::get_iso_spacing() { return this->params_.get(Keys::ISO_SPACING, Defaults::iso_spacing); }

//---------------------------------------------------------------------------
void GroomParameters::set_iso_spacing(double spacing) { this->params_.set(Keys::ISO_SPACING, spacing); }
...
//---------------------------------------------------------------------------
void GroomParameters::set_spacing(std::vector<double> spacing) { this->params_.set(Keys::SPACING, spacing); }

//---------------------------------------------------------------------------
bool GroomParameters::get_remesh() { return this->params_.get(Keys::REMESH, Defaults::remesh); }

//---------------------------------------------------------------------------
void GroomParameters::set_remesh(bool remesh) { this->params_.set(Keys::REMESH, remesh); }
...
//---------------------------------------------------------------------------
void GroomParameters::set_remesh_percent_mode(bool mode) { this->params_.set(Keys::REMESH_PERCENT_MODE, mode); }
...
//---------------------------------------------------------------------------
void GroomParameters::set_remesh_percent(double percent) { this->params_.set(Keys::REMESH_PERCENT, percent); }
...
//---------------------------------------------------------------------------
void GroomParameters::set_remesh_gradation(double gradation) { this->params_.set(Keys::REMESH_GRADATION, gradation); }
