...
public:
  ...
  /// creates a transform based on transform type (currently only accepts IterativeClosestPoint), specified AlignmentType (Mesh::Rigid, Mesh::Similarity, Mesh::Affine) for specified number of iterations
