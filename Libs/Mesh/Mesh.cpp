...
Mesh& Mesh::computeThickness(Image &image, Image *dt, double threshold, double min_dist, double max_dist, std::string distance_mesh) {
  mesh::compute_thickness(*this, image, dt, threshold, min_dist, max_dist, distance_mesh);
  return *this;
}
