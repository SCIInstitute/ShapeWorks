...
def Run_Pipeline(args):
    ...
    shape_models_dir = ellipsoids_dir+'/shape_models/ellipsoid_multiscale_particles'
    if args.tiny_test:
        shape_models_dir = ellipsoids_dir+'/shape_models/ellipsoid_tiny_test_multiscale_particles'
