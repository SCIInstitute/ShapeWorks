...
step is explained including the pre-processing (grooming), optimization, and analysis
...
def Run_Pipeline(args):
    ...
    and apply the initial grooming steps
    """
    ...
    the ShapeWorks project for optimization.
...
#    project_file = output_directory + "ellipsoid_" + args.option_set + ".swproj"
    ...
    # Run optimization
    optimize_cmd = ('shapeworks optimize --progress --name ' + project_file).split()
    subprocess.check_call(optimize_cmd)

    # If tiny test or verify, check results and exit
    sw.utils.check_results(args, project_file)
    ...
    """
    analyze_cmd = ('ShapeWorksStudio ' + project_file).split()
