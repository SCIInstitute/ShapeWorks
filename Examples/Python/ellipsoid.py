...
def Run_Pipeline(args):
    ...
    if args.skip_grooming:
        ...
        """
        refIndex = TempUtils.findReferenceImageIndex(shapeSegList)
        ...
        dtFiles = TempUtils.saveImages(groomDir + 'distance_transforms/', shapeSegList, shapeNames, extension='nrrd', compressed=False, verbose=True)
