...
python -c "import sys; print('\n'.join(sys.path))" > "%USERPROFILE%\.shapeworks\python_path_6.9.txt"
python -c "import sys; print(sys.prefix)" > "%USERPROFILE%\.shapeworks\python_home_6.9.txt"
echo %PATH% > "%USERPROFILE%\.shapeworks\path_6.9.txt"
call conda info
