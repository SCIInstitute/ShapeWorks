...
function install_conda() {
  ...
  if ! pip install pyqt5==5.15.6                        then return 1l fi # for jupyter notebook visualization
  if ! pip install pyvistaqt==0.6.0                     then return 1l fi # for jupyter notebook visualization
